...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.settings_task_borderless_checkbox = QtGui.QCheckBox(self.settings_tasks_group)
        self.settings_task_borderless_checkbox.setObjectName(_fromUtf8("settings_task_borderless_checkbox"))
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.settings_task_fullscreen_checkbox.setText(_translate("SettingsDialog", "Fullscreen", None))
        self.settings_task_borderless_checkbox.setText(_translate("SettingsDialog", "Borderless", None))
