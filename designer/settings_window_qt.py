...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.verticalLayout_6.addWidget(self.settings_task_fullscreen_checkbox)
        ...
        self.verticalLayout_6.addWidget(self.settings_task_borderless_checkbox)
        ...
        self.verticalLayout_6.addLayout(self.settings_task_size)
        self.verticalLayout_7.addLayout(self.verticalLayout_6)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_7.addItem(spacerItem)
        self.settings_task_fullscreen_checkbox.raise_()
        self.toolBox.addItem(self.task_windows_page, "")
        self.ant_page = QtWidgets.QWidget()
        self.ant_page.setGeometry(QtCore.QRect(0, 0, 417, 509))
        self.ant_page.setObjectName("ant_page")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.ant_page)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.toolBox.addItem(self.ant_page, "")
        self.digit_backward_page = QtWidgets.QWidget()
        self.digit_backward_page.setObjectName("digit_backward_page")
        self.toolBox.addItem(self.digit_backward_page, "")
        self.ravens_page = QtWidgets.QWidget()
        self.ravens_page.setObjectName("ravens_page")
        self.toolBox.addItem(self.ravens_page, "")
        self.sart_page = QtWidgets.QWidget()
        self.sart_page.setObjectName("sart_page")
        self.toolBox.addItem(self.sart_page, "")
        self.sternberg_page = QtWidgets.QWidget()
        self.sternberg_page.setObjectName("sternberg_page")
        self.toolBox.addItem(self.sternberg_page, "")
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.task_windows_page), _translate("SettingsDialog", "Task Windows"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.ant_page), _translate("SettingsDialog", "Attentional Network Test"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.digit_backward_page), _translate("SettingsDialog", "Digit Span (backwards)"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.ravens_page), _translate("SettingsDialog", "Raven\'s Progressive Matrices"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.sart_page), _translate("SettingsDialog", "Sustained Attention to Response Task"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.sternberg_page), _translate("SettingsDialog", "Sternberg Task"))
