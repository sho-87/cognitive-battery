...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 391, 292))
        ...
        self.general_page.setGeometry(QtCore.QRect(0, 0, 373, 139))
        ...
        self.ant_page.setGeometry(QtCore.QRect(0, 0, 373, 139))
        ...
        self.flanker_page.setGeometry(QtCore.QRect(0, 0, 373, 139))
        ...
        self.settings_flanker_compatibility = QtWidgets.QCheckBox(self.flanker_page)
        self.settings_flanker_compatibility.setObjectName("settings_flanker_compatibility")
        self.flanker_form.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.settings_flanker_compatibility)
        self.settings_flanker_block_label = QtWidgets.QLabel(self.flanker_page)
        self.settings_flanker_block_label.setObjectName("settings_flanker_block_label")
        self.flanker_form.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.settings_flanker_block_label)
        self.settings_flanker_block_value = QtWidgets.QLineEdit(self.flanker_page)
        self.settings_flanker_block_value.setObjectName("settings_flanker_block_value")
        self.flanker_form.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.settings_flanker_block_value)
        ...
        self.ravens_page.setGeometry(QtCore.QRect(0, 0, 373, 139))
        ...
        self.sternberg_page.setGeometry(QtCore.QRect(0, 0, 373, 139))
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.settings_flanker_compatibility.setText(_translate("SettingsDialog", "Compatibility condition"))
        self.settings_flanker_block_label.setText(_translate("SettingsDialog", "Number of blocks:"))
